...
1. **Wasserstein Learning of Deep Generative Point Process Models**. *Shuai Xiao, Mehrdad Farajtabar, Xiaojing Ye, Junchi Yan, Le Song, Hongyuan Zha*. NeurIPS 2017. [[pdf](https://arxiv.org/pdf/1705.08051.pdf)]
1. **Recurrent Marked Temporal Point Processes: Embedding Event History to Vector**. *Nan Du, Hanjun Dai, Rakshit Trivedi, Utkarsh Upadhyay, Manuel Gomez-Rodriguez, and Le Song*. KDD 2016. [[pdf](https://www.kdd.org/kdd2016/papers/files/rpp1081-duA.pdf)] 
